...
/**
 * A Mock test class for ViewImplPlayBackGUI. Contains log, which keeps track of which methods
 * we've called.
 */
public class MockPlayBackGUIView extends ViewImplPlayBackGUI {

  private StringBuilder log;

  /**
   * Same constructor as ViewImplPlayBackGUI, but contains a log that tracks the methods called.
   ...
   */
  public MockPlayBackGUIView(String outputName, int ticksPerSecond, StringBuilder log) {
